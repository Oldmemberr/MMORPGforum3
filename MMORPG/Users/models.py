...
class Post(models.Model):
    ...
    avthor = models.OneToOneField(User, on_delete=models.CASCADE, related_name='author', default="")
    categoryType = models.CharField(default='', max_length=64, choices=ROLES)
